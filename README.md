...
<body>
    <main>
        ...
        <div class="passo" id="passo-1">
            ...
            <button class="btn-proximo" data-prhttps://github.com/femascheti/criando-sua-aventura/blob/aula-07/img/cenario-passo0.png?raw=trueoximo="4">Desistir e voltar para casa</button>
        </div>
